...
All date filters accept multiple formats:

| Format | Example | Meaning |
|--------|---------|---------|
| Keywords | `today`, `tomorrow` | Exact date |
| Weekdays | `monday`, `friday`, `wed` | Next occurrence |
| Relative | `this-week` | Within 7 days |
| ISO 8601 | `2025-01-15` | Exact date |

In output, dates are always shown in ISO 8601 format (`YYYY-MM-DD`).
