...
Check for error codes in the output. Common ones:

| Code | Meaning | What to Do |
|------|---------|------------|
| `NOT_FOUND` | Entity doesn't exist | Check the path/title |
| `AMBIGUOUS` | Multiple matches | Use a more specific query or exact path |
| `INVALID_STATUS` | Status value not allowed | Check valid statuses for entity type |
| `PARSE_ERROR` | File couldn't be parsed | Run `tdn doctor --ai` for details |
