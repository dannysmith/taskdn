...
You can open the preferences fro the **File** menu or the [command palette](/desktop/command-palette/). It contains a number of panes.
...
2. **Permanently Delete Tasks** - By default, tasks deleted via the desktop app are moved to the system recycle bin/trash can. With this switch enabled, they will instead be permenantly deleted.
