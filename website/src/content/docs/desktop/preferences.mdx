...
import prefsGeneral from '@assets/docs/2026-01-19-prefs-general.png'
import prefsVault from '@assets/docs/2026-01-19-prefs-vault-paths.png'
import prefsQuickEntry from '@assets/docs/2026-01-19-prefs-quickentry.png'
...
<Center>
<Image src={prefsGeneral} alt="General preferences pane" />
</Center>
...
<Center>
<Image src={prefsVault} alt="Vault preferences pane" />
</Center>
...
<Center>
<Image src={prefsQuickEntry} alt="Quick Entry preferences pane" />
</Center>
