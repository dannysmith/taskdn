...
- Issue: The find\_\*\_by_title functions clone entities from the index. For large result sets, this could be expensive.
...
4. **Optimize VaultConfig Usage**
   ...
   - Change scan\_\* functions to take &VaultConfig
