...
export declare class Taskdn {
   ...
   */
  validateAllTasks(): Array<ValidationError>
  /**
   ...
   */
  updateTasksMatching(filter: TaskFilter, updates: TaskUpdates): BatchResult
  /**
   ...
   */
  listProjects(filter?: ProjectFilter | undefined | null): Array<Project>
  /**
   ...
   * Returns an error if the tasks directory cannot be read.
   */
  getTasksForProject(path: string): Array<Task>
  /**
   ...
   */
  listAreas(filter?: AreaFilter | undefined | null): Array<Area>
  /**
   ...
   */
  getTasksForArea(path: string): Array<Task>
  /**
   ...
   * Returns an error if the projects directory cannot be read.
   */
  getProjectsForArea(path: string): Array<Project>
  /**
   ...
   * ```
   */
  processFileChange(path: string, kind: string): VaultEvent | null
  /**
...
export declare const enum FileChangeKind {
