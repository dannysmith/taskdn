...
export function TaskDndContext({
  ...
  const handleDragOver = (event: DragOverEvent) => {
    ...
    const insertBeforeId = overData?.type === 'task' ? overData.taskId : null
