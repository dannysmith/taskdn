        ...
        <SortableContext items={taskIds} strategy={verticalListSortingStrategy}>
          {tasks.map(task => (
            <SortableKanbanCard
              ...
              status={status}
              projectName={
                task.project ? getProjectName?.(task.project) : undefined
              }
              areaName={task.area ? getAreaName?.(task.area) : undefined}
              onStatusChange={
                onTaskStatusChange
              ...
              onProjectClick={
                task.project && onProjectClick
                  ? () => onProjectClick(task.project as string)
                  : undefined
              }
              onAreaClick={
                task.area && onAreaClick
