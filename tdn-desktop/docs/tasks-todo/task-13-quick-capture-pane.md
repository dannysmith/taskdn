...
- A status must be able to be added in a similar way to the right sidebar.
- Scheduled, due and defer-until dates must be able to be added in a similar way to the right sidebar
- All this must be easily keyboard navigable and work and look slick and efficient when entering.
